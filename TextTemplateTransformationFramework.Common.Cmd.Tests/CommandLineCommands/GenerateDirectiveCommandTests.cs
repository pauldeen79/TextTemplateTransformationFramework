...
namespace TextTemplateTransformationFramework.Common.Cmd.Tests.CommandLineCommands
{
    ...
    public class GenerateDirectiveCommandTests
    {
        ...
        {
            TestHelpers.ConstructorMustThrowArgumentNullException(typeof(GenerateDirectiveCommand<MyDirectiveModel>));
        }
        ...
        [Fact]
        public void Can_Generate_Output_With_Parameter()
        {
            // Arrange
            var argument = "-n MyDirective";
