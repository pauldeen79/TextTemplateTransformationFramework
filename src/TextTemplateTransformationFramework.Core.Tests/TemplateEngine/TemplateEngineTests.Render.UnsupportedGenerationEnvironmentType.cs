...
public partial class TemplateEngineTests
{
    public class UnsupportedGenerationEnvironmentType
    {
        ...
        public void Throws()
        {
            ...
            var request = new RenderTemplateRequest(new TestData.Template(_ => { }), new StringBuilder(), string.Empty, null, null); // note that we can't put a non-supported type in here because the interface prevents that. But the construction above accomplishes that.
