...
public partial class TemplateEngineTests
{
    public class UnsupportedGenerationEnvironmentType
    {
        ...
        public void Throws()
        {
            ...
            var request = new RenderTemplateRequest<object?>(new TestData.Template(_ => { }), new StringBuilder(), string.Empty, null, null, null); // note that we can't put a non-supported type in here because the interface prevents that. But the construction above accomplishes that.
