...
public partial class TemplateEngineTests
{
    public class UnsupportedGenerationEnvironmentType
    {
        ...
        {
            // Arrange
            var sut = new TemplateEngine(new TemplateInitializer(), Array.Empty<ITemplateRenderer>()); // we are specifying here that no renderers are known, so even StringBuilder throws an exception :)
