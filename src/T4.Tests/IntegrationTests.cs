...
Hello <#= ""world"" #><# Write(""!""); #>";
        ...
        public void EmptyExpression_Leads_To_CompilerError()
        {
            ...
            actual.CompilerErrors.First(e => !e.IsWarning).ErrorText.Should().Be("There is no argument given that corresponds to the required parameter 'objectToConvert' of 'GeneratedClassBase.ToStringInstanceHelper.ToStringWithCulture(object)'");
        }
