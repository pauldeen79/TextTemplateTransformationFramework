...
namespace TextTemplateTransformationFramework.Runtime
{
    public static class TemplateRenderHelper
    {
                                                   ...
                                                   bool defaultSkipWhenFileExists = false)
        {
            ...
            if (s.Contains(@"<MultipleContents xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns=""http://schemas.datacontract.org/2004/07/TextTemplateTransformationFramework"">"))
            {
