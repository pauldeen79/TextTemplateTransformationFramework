...
"));
        ...
        public virtual void Initialize(global::System.Action additionalActionDelegate = null)
        {
            ...
            if (additionalActionDelegate is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("Model") && this.Session["Model"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("TemplateNamespace") && this.Session["TemplateNamespace"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("TemplateClassName") && this.Session["TemplateClassName"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("GeneratorName") && this.Session["GeneratorName"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("GeneratorVersion") && this.Session["GeneratorVersion"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("TemplateIsOverride") && this.Session["TemplateIsOverride"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("CultureCode") && this.Session["CultureCode"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("SkipInitializationCode") && this.Session["SkipInitializationCode"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("BaseClassInheritsFrom") && this.Session["BaseClassInheritsFrom"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("GenerationEnvironmentAccessor") && this.Session["GenerationEnvironmentAccessor"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("AddTemplateLineNumbers") && this.Session["AddTemplateLineNumbers"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("EnvironmentVersion") && this.Session["EnvironmentVersion"] is not null)
            {
            ...
            if (this.Session is not null && this.Session.ContainsKey("AddExcludeFromCodeCoverageAttribute") && this.Session["AddExcludeFromCodeCoverageAttribute"] is not null)
            {
...
{
    return childTemplateModelType is not null
...
protected virtual bool ShouldRenderLineNumberAndFooter(object template, object model, int? iterationNumber = null, int? iterationCount = null, string resolveTemplateName = null)
{
    return
        ...
        && ((ITemplateToken<TokenParserState>)model).SectionContext?.FileName is not null
